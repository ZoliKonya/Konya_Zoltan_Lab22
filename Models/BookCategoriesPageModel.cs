...
namespace Konya_Zoltan_Lab22.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Konya_Zoltan_Lab22Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Konya_Zoltan_Lab22Context context, string[] selectedCategories, Book bookToUpdate)
        {
